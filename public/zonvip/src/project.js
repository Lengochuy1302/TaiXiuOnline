window.__require = function t(e, i, n) {
    ...
    BaoMat: [function(t, e, i) {
        ...
        cc.Class({
            ...
            onSelectHead: function(t, e) {
                if (Promise.all(this.header.map(function(t) {
                    t.node.name == e ? t.select() : t.unselect()
                })),
                Promise.all(this.body.map(function(t) {
                ...
                "DangKyOTP" == e) {
                    var i = JSON.parse(cc.sys.localStorage.getItem("infoRed8"));
                    this.DangKyOTP.statusOTP(!!i.phone)
                }
            }
        }),
        cc._RF.pop()
    ...
    ChuyenRed: [function(t, e, i) {
        ...
        cc.Class({
            ...
            onChuyenClick: function() {
                var t = null;
                if (o.isEmpty(this.nickname.string) || o.isEmpty(this.renickname.string) || o.isEmpty(this.red.string) ? (console.log("vao?????????????", 18),
                t = "Ki\u1ec3m tra l\u1ea1i c\xe1c th\xf4ng tin...") : o.isEmpty(this.nickname.string) || o.isEmpty(this.renickname.string) ? t = "T\xean nh\xe2n v\u1eadt kh\xf4ng \u0111\u01b0\u1ee3c b\u1ecf tr\u1ed1ng" : this.nickname.string != this.renickname.string ? t = "T\xean nh\xe2n v\u1eadt kh\xf4ng kh\u1edbp.!!" : o.getOnlyNumberInString(this.red.string) < 1e4 ? t = "S\u1ed1 ti\u1ec1n chuy\u1ec3n t\u1ed1i thi\u1ec3u l\xe0 10.000 Red." : o.isEmpty(this.otp.string) && (t = "Vui l\xf2ng nh\u1eadp m\xe3 OTP."),
                t)
    ...
    DangKyOTP: [function(t, e, i) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                e && (this.labelPhone.string = e.phone,
            ...
            addEvent: function() {
                for (var t in cc.systemEvent.on(cc.SystemEvent.EventType.KEY_DOWN, this.onKeyDown, this),
                this.editboxs)
                    this.editboxs[t] && n.getHTMLElementByEditBox(this.editboxs[t]).addEventListener("keydown", this.keyHandle, !1)
            },
            removeEvent: function() {
                for (var t in cc.systemEvent.off(cc.SystemEvent.EventType.KEY_DOWN, this.onKeyDown, this),
                this.editboxs)
                    this.editboxs[t] && n.getHTMLElementByEditBox(this.editboxs[t]).removeEventListener("keydown", this.keyHandle, !1)
            },
            onKeyDown: function(t) {
                switch (t.keyCode) {
                case cc.macro.KEY.tab:
            ...
            onGetOTP: function() {
                o.checkPhoneValid(this.phone.string) ? 1 == this.typeOTP ? cc.RedT.send({
                    user: {
                        security: {
                            OTPTele: this.phone.string
                        }
                    }
                }) : cc.RedT.send({
                    user: {
                        security: {
                            OTPSMS: this.phone.string
                        }
                    }
                }) : cc.RedT.inGame.notice.show({
                    title: "L\u1ed6I!",
                    text: "S\u1ed1 \u0111i\u1ec7n tho\u1ea1i kh\xf4ng \u0111\xfang \u0111\u1ecbnh d\u1ea1ng"
                })
            },
            onTaiTeleClick: function() {
                cc.sys.openURL("https://t.me/zonvipotpbot")
            },
            onRegClick: function() {
            ...
            clear: function() {
                ...
                this.email && (this.email.string = ""),
                this.cmt && (this.cmt.string = ""),
        ...
        var n = t("Helper")
          ...
          , m = cc.Class({
            ...
            playSoundBG: function() {
                var t = m.scope.randomBetween(0, 4);
                cc.audioEngine.playMusic(m.scope.arr_sound_bg[t], !1),
                clearTimeout(m.scope.timeout_Play_Sound),
                m.scope.timeout_Play_Sound = setTimeout(function() {
                    m.scope.playSoundBG()
                }, 1e3 * m.scope.arr_Time_Sound[t])
            },
            auth: function(t) {
                this.loading.active = !0,
                null == cc.RedT._socket || 1 != cc.RedT._socket.readyState ? setTimeout(function() {
    ...
    MomoController: [function(t, e, i) {
        ...
        cc.Class({
            ...
            onData: function(t) {
                if (console.log("??????" + t),
                void 0 !== t.info && void 0 !== t.account && this.isLoading) {
                    this.isLoading = !1;
                    var e = t.account;
                    this.phoneLabel.string = e.phone,
                    this.nameLabel.string = e.name,
                    this.cachingSyntax = e.syntax,
                    this.syntaxLabel.string = e.syntax.replace(":", "}"),
                    this.noteLabel.string = "Kh\xf4ng gi\u1ea3i quy\u1ebft c\xe1c tr\u01b0\u1eddng h\u1ee3p chuy\u1ec3n nh\u1ea7m STK\nv\xe0 sai n\u1ed9i d\u1ee5ng.\nGiao d\u1ecbch t\u1ed1i thi\u1ec3u " + e.min + " t\u1ed1i \u0111a " + e.max;
                    for (var i = t.info.menhgia, o = 0; o < i.length; o++) {
                        var c = i[o].name;
                        c = n.numberWithCommas(c);
                        var s = i[o].values3;
                        s = n.numberWithCommas(s),
                        this.descLabel.string += c + " VN\u0110 } " + s + " ZON\n"
                    }
                }
            },
    ...
    NapRed: [function(t, e, i) {
        ...
        cc.Class({
            ...
            infoSet: function(t, e, i) {
                ...
                console.log("nap red: " + JSON.stringify(t));
                var s = this;
    ...
    Poker: [function(t, e, i) {
        ...
        cc.Class({
            ...
            infoRoom: function(t) {
                ...
                this.labelBet.string = o.numberWithCommas(t.game) + (t.red ? " ZON" : " XU")
            },
            ingame: function(t) {
    ...
    SignIn: [function(t, e, i) {
        ...
        cc.Class({
            ...
            onLoginClick: function() {
                var t = null;
                this.username.string.length > 32 || this.username.string.length < 3 || null === this.username.string.match(new RegExp("^[a-zA-Z0-9]+$")) ? t = "T\xean t\xe0i kho\u1ea3n kh\xf4ng \u0111\xfang!!" : (this.password.string.length > 32 || this.password.string.length < 6) && (t = "M\u1eadt kh\u1ea9u kh\xf4ng \u0111\xfang!!"),
                t ? cc.RedT.inGame.notice.show({
                    title: "\u0110\u0102NG NH\u1eacP",
                    text: t
                }) : cc.RedT.inGame.auth({
    ...
    TaiXiuBoard: [function(t, e, i) {
        ...
        cc.Class({
            ...
            onChangerTypeClick: function() {
                ...
                this.textType.string = "CH\u1eccN") : (this.nodeChonSo.active = !1,
                this.nodeChonTien.active = !0,
                this.textType.string = "S\u1ed0 KH\xc1C")
            },
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                this.keyHandle = function(e) {
                    return e.keyCode === cc.macro.KEY.tab ? (t.changeNextFocusEditBox(),
                    e.preventDefault && e.preventDefault(),
                    !1) : e.keyCode === cc.macro.KEY.enter ? (c.focusGame(),
                    t.onCuocClick(),
                    e.preventDefault && e.preventDefault(),
                    !1) : void 0
                }
                ...
                this.onCuocClick = function() {
                    ...
                    isNaN(e) || e < 1e3) {
                        ...
                        i.getComponent("mini_warning").text.string = "Ti\u1ec1n c\u01b0\u1ee3c ph\u1ea3i l\u1edbn h\u01a1n 1.000 " + (t.red ? "ZON" : "Xu"),
                        t.notice.addChild(i)
                    } else
                        cc.RedT.send({
                            taixiu: {
            ...
            onEnable: function() {
                ...
                this.RedT.board && (c.inputAddEvent(this.inputLeft, "input", this.updateValue),
            ...
            onDisable: function() {
                ...
                this.RedT.board && (c.inputRemoveEvent(this.inputLeft, "input", this.updateValue),
            ...
            addEvent: function() {
                for (var t in this.editboxs)
                    c.getHTMLElementByEditBox(this.editboxs[t]).addEventListener("keydown", this.keyHandle, !1)
            },
            removeEvent: function() {
                for (var t in this.editboxs)
                    c.getHTMLElementByEditBox(this.editboxs[t]).removeEventListener("keydown", this.keyHandle, !1)
            },
            changeNextFocusEditBox: function() {
                for (var t = !1, e = 0, i = this.editboxs.length; e < i; e++)
            ...
            playTime: function() {
                ...
                this.timeInterval = setInterval(function() {
                    if (cc.RedT.setting.taixiu.time_remain > 61) {
                        ...
                        cc.RedT.setting.taixiu.time_remain < 66 && (this.nodeKetQua.active = !1,
            ...
            onDataChanLe: function(t) {
                this.red ? (void 0 !== t.red_chan && (this.totalLeft.string = s.numberWithCommas(t.red_chan)),
                void 0 !== t.red_le && (this.totalRight.string = s.numberWithCommas(t.red_le)),
                void 0 !== t.red_me_chan && (this.myLeft.string = s.numberWithCommas(t.red_me_chan)),
                void 0 !== t.red_me_le && (this.myRight.string = s.numberWithCommas(t.red_me_le)),
                void 0 !== t.red_player_chan && (this.playerLeft.string = s.numberWithCommas(t.red_player_chan)),
                void 0 !== t.red_player_le && (this.playerRight.string = s.numberWithCommas(t.red_player_le))) : (void 0 !== t.xu_chan && (this.totalLeft.string = s.numberWithCommas(t.xu_chan)),
            ...
            onDataTaiXiu: function(t) {
                ...
                this.red ? (void 0 !== t.red_tai && (this.totalLeft.string = s.numberWithCommas(t.red_tai)),
                void 0 !== t.red_xiu && (this.totalRight.string = s.numberWithCommas(t.red_xiu)),
                ...
                void 0 !== t.red_player_xiu && (this.playerRight.string = s.numberWithCommas(t.red_player_xiu))) : (void 0 !== t.xu_tai && (this.totalLeft.string = s.numberWithCommas(t.xu_tai)),
            ...
            dataLogs: function() {
                if (cc.RedT.setting.taixiu.logs.length) {
                    ...
                    var e = []
                      ...
                      , h = 0
                      , r = 0
                      , u = cc.RedT.setting.taixiu.logs.slice(0, 19);
                    u.reverse();
                    ...
                    var d = Promise.all(this.RedT.TX_ThongKe.KetQuaDot.map(function(e, i) {
                        var n = cc.RedT.setting.taixiu.logs[i];
                        if (void 0 !== n) {
                            e.node.active = !0;
                            var o = n.dice[0] + n.dice[1] + n.dice[2];
                      ...
                      , l = new Promise(function(e, i) {
                        ...
                        var o = !0
                          ...
                          , r = void 0;
                        try {
                            for (var u, d = n[Symbol.iterator](); !(o = (u = d.next()).done); o = !0) {
                                var l = u.value
                                  , p = l.dice[0] + l.dice[1] + l.dice[2]
                                  , g = t.taixiu ? p > 10 ? 1 : 0 : p % 2 ? 0 : 1;
                                -1 === c && (c = g),
                                (g != c || a.length > 4) && (c = g,
                                s.push(a),
                                a = []),
                    ...
                    Promise.all([d, l]).then(function(e) {
                        var i = e[1];
                        i.reverse(),
    ...
    XocXoc: [function(t, e, i) {
        ...
        cc.Class({
                ...
                try {
                    for (var c, s = Object.entries(t)[Symbol.iterator](); !(e = (c = s.next()).done); e = !0) {
                        ...
                        var l = !0
                          ...
                          , g = void 0;
                        try {
                            for (var m, f = Object.entries(u)[Symbol.iterator](); !(l = (m = f.next()).done); l = !0) {
                                var v = m.value
                                  , T = n(v, 2)
                                  , b = T[0]
                                  , _ = T[1];
                                if (_ > 0)
                                    for (; _; ) {
                                        var C = Math.random() * (d.x + 1) >> 0
                                          , y = Math.random() * (d.y + 1) >> 0
                                          , R = new cc.Node;
            ...
            updateData: function(t) {
                this.red ? (this.total_chan.string = t.red.chan > 0 ? o.numberWithCommas(t.red.chan) : "",
                ...
                this.total_white4.string = t.red.white4 > 0 ? o.numberWithCommas(t.red.white4) : "") : (this.total_chan.string = t.xu.chan > 0 ? o.numberWithCommas(t.xu.chan) : "",
            ...
            updateMeCoint: function() {
                this.red ? (this.me_chan.string = this.users.red.chan > 0 ? o.numberWithCommas(this.users.red.chan) : "",
                ...
                this.total_white4.string = this.clients.red.white4 > 0 ? o.numberWithCommas(this.clients.red.white4) : "") : (this.me_chan.string = this.users.xu.chan > 0 ? o.numberWithCommas(this.users.xu.chan) : "",
    ...
    shopMuaTheCao: [function(t, e, i) {
        ...
        cc.Class({
            ...
            infoSet: function(t, e, i) {
                var n = this
                  , c = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
                console.log("tieu red: " + JSON.stringify(t));
                var s = this;
                t.length > 0 && Promise.all(t.map(function(t, n) {
                    var a = cc.instantiate(s.prefabLeft)
                      , h = a.getComponent("NapRed_itemOne");
                    ...
                    c)
                        ...
                        var r = o.numberWithCommas(t.name)
                          , u = o.numberWithCommas(t.values2);
                        0 == n && (h.background.active = !0,
                        s.MenhGia.string = r),
                        h.text.string = r,
                        s.scrollviewMenhGia.content.addChild(a);
            ...
            onClickMua: function() {
                ...
                }) : 6 != this.editOTP.string.length ? cc.RedT.inGame.notice.show({
                    title: "L\u1ed6I",
        ...
        cc.Class({
            ...
            onClickMua: function() {
                parseInt(n.isEmpty(this.red.string) || n.getOnlyNumberInString(this.red.string)) < 1e3 ? cc.RedT.inGame.notice.show({
                    title: "MUA XU",
                    text: "S\u1ed1 ZON mua XU t\u1ed1i thi\u1ec3u l\xe0 1.000"
        ...
        cc.Class({
            ...
            onClickItem: function(t) {
                ...
                var a = !0
                  ...
                  , r = void 0;
                try {
                    for (var u, d = this.body[Symbol.iterator](); !(a = (u = d.next()).done); a = !0) {
                        var l = u.value;
